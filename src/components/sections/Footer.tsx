...
export default function Footer() {
    return (
        <footer className="bg-coffee-900 text-center text-brown-900 flex flex-col items-center justify-center rounded-lg px-4 py-6">
            ...
            <ul className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6 lg:space-x-10 text-lg lg:text-xl font-medium justify-center items-center">
                <li className={`${hoverScale}`}>
                    <a href="#" className="text-brown-900 hover:text-brown-700">Privacy Policy</a>
                </li>
                <li className={`${hoverScale}`}>
                    <a href="#" className="text-brown-900 hover:text-brown-700">Terms of Service</a>
                </li>
            </ul>
        </footer>
    );
